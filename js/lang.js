...
const LANG_JP = {
    ...
    SETUP_GURAPPS_USAGE: "Gurappsの使用",
    SETUP_GURAPPS_USAGE_DESC: "Gurappsを使用するには、下のピルから上にスワイプしてGurappを選択して起動します。",
...
const LANG_DE = {
    ...
    SETUP_GURAPPS_USAGE: "Gurapps-Nutzung",
    SETUP_GURAPPS_USAGE_DESC: "Um Gurapps zu verwenden, wischen Sie vom unteren Balken nach oben und wählen Sie eine Gurapp zum Starten aus.",
...
const LANG_FR = {
    ...
    SETUP_GURAPPS_USAGE: "Utilisation de Gurapps",
    SETUP_GURAPPS_USAGE_DESC: "Pour utiliser Gurapps, glissez vers le haut depuis la barre du bas et choisissez une Gurapp à lancer.",
...
const LANG_ES = {
    ...
    SETUP_GURAPPS_USAGE_DESC: "Para usar Gurapps, desliza hacia arriba desde la barra inferior y elige una Gurapp para iniciar.",
...
const LANG_KO = {
    ...
    SETUP_GURAPPS_USAGE: "Gurapps 사용법",
    SETUP_GURAPPS_USAGE_DESC: "Gurapps를 사용하려면 하단 막대에서 위로 스와이프하고 시작할 Gurapp을 선택하십시오.",
...
const LANG_ZH = {
    ...
    SETUP_GURAPPS_USAGE: "Gurapps的使用",
    SETUP_GURAPPS_USAGE_DESC: "要使用Gurapps，请从底部药丸向上滑动并选择要启动的Gurapp。",
