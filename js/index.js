            ...
            switch (current.weathercode) {
                ...
                case 80: case 81: case 82: // Showers
                    ...
                    weatherElements += `
                        ...
                        <div class="rain morning ${current.weathercode >= 80 ? 'heavy' : (current.weathercode >= 63 ? 'medium' : 'light')}"></div>
                    `;
                    break;
                ...
                case 96: case 99: // Thunderstorm with Hail
                    ...
                    weatherElements += `
                        ...
                        <div class="rain heavy morning"></div>
            ...
            switch (current.weathercode) {
                ...
                case 80: case 81: case 82: // Showers
                    ...
                    weatherElements += `
                        ...
                        <div class="rain midday ${current.weathercode >= 80 ? 'heavy' : (current.weathercode >= 63 ? 'medium' : 'light')}"></div>
                    `;
                    break;
                ...
                case 96: case 99: // Thunderstorm with Hail
                    ...
                    weatherElements += `
                        ...
                        <div class="rain heavy midday"></div>
            ...
            switch (current.weathercode) {
                ...
                case 80: case 81: case 82: // Showers
                    ...
                    weatherElements += `
                        ...
                        <div class="rain evening ${current.weathercode >= 80 ? 'heavy' : (current.weathercode >= 63 ? 'medium' : 'light')}"></div>
                    `;
                    break;
                ...
                case 96: case 99: // Thunderstorm with Hail
                    ...
                    weatherElements += `
                        ...
                        <div class="rain heavy evening"></div>
        ...
        switch (current.weathercode) {
            ...
            case 80: case 81: case 82: // Showers
                ...
                weatherElements += `
                    ...
                    <div class="rain night ${current.weathercode >= 80 ? 'heavy' : (current.weathercode >= 63 ? 'medium' : 'light')}"></div>
                `;
                break;
            ...
            case 96: case 99: // Thunderstorm with Hail
                ...
                weatherElements += `
                    ...
                    <div class="rain heavy night"></div>
    ...
    document.querySelectorAll('body > *').forEach(el => {
        if (!el.matches('.drawer-handle, .persistent-clock, #app-drawer, .brightness-overlay, .temperature-overlay, .fullscreen-embed')) {
            if (el.id === 'customizeModal') {
                el.style.display = 'none'; // Keep this one hidden
            } else {
